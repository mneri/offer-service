 ...
 * @author Massimo Neri
 */
@Component("authoritySpec")
@RequiredArgsConstructor(access = AccessLevel.PROTECTED)
class AuthoritySpecImpl implements AuthoritySpec {
    /**
     * {@inheritDoc}
     */
    @Override
    public Specification<Authority> isEnabled() {
     ...
     */
    @Override
    public Specification<Authority> ownerIdIsEqualTo(UUID userId) {
